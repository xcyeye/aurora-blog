...
import xyz.xcye.util.id.GenerateInfoUtil;
...
public class JwtUtil {
    ...
    public static String generateToken(String subject,String issuer, long expirationTime,
        ...
        return Jwts.builder()
                .setId(GenerateInfoUtil.generateUid(10, 10) + "")
                //设置标题和签发者
     ...
     */
    public static JwtEntity parseJwtToken(String jwtToken,byte[] secretKey) throws RuntimeException {
        Claims claims = null;
        try {
            claims = Jwts.parser()
        ...
        JwtEntity jwtEntity = new JwtEntity(claims.getId(),claims.getSubject(),
