						...
						<n-tab-pane name="the beatles" tab="申请">
							<n-space vertical>
									...
									storageMode: 0
													...
													>
														<template #extraButton>
															<n-button v-if="applyForFriendLink.linkCover" round type="success" @click="handleRemoveLinkCoverAction">移除封面</n-button>
														</template>
													</upload-file>
												</n-space>
											</n-tab-pane>
								...
								<n-card hoverable class="rounded-16px shadow-sm" size="small">
									...
									<template #footer>
										<n-space justify="end">
											<n-button strong secondary tertiary round type="success" @click="handleApplyLinkAction">申请</n-button>
										</n-space>
									</template>
								</n-card>
							</n-space>
