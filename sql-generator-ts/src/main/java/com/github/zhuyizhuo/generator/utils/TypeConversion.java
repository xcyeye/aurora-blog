...
public class TypeConversion {
    ...
    private static void initMysqlType2JavaMap() {
        mySqlDbType2JavaMap.put("INT","number");
        ...
        mySqlDbType2JavaMap.put("DECIMAL","string");
        mySqlDbType2JavaMap.put("TINYINT","boolean");
        mySqlDbType2JavaMap.put("BIGINT","string");
        mySqlDbType2JavaMap.put("FLOAT","string");
        mySqlDbType2JavaMap.put("DOUBLE","string");
        mySqlDbType2JavaMap.put("DATE","string");
        mySqlDbType2JavaMap.put("TIME","string");
        mySqlDbType2JavaMap.put("DATETIME","string");
        mySqlDbType2JavaMap.put("TIMESTAMP","string");
        mySqlDbType2JavaMap.put("YEAR","number");
    }
