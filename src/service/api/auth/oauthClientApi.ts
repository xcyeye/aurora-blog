...
type beanType = OauthClientDetails;
type viewBeanType = OauthClientDetailsVo;
...
function _baseApi() {
	...
	function insertData(data: beanType) {
		return request.post<void>(`${apiPrefix}insertOauthClient`, data, baseAxiosRequestConfig);
	}
	...
	function physicalDeleteData(data: beanType) {
		return request.post<number>(`${apiPrefix}physicalDeleteOauthClient`, data, baseAxiosRequestConfig);
	}
	...
	function updateData(data: beanType) {
		return request.post<number>(`${apiPrefix}updateOauthClient`, data, baseAxiosRequestConfig);
	}
	...
	function queryListDataByCondition(data: Condition) {
		return request.post<PageData<viewBeanType>>(`${apiPrefix}queryListOauthClientByCondition`, data, baseAxiosRequestConfig);
	}
	 ...
	 * @param data
	 */
	function queryOneOauthClientByClientId(data: beanType) {
		return request.post<viewBeanType>(`${apiPrefix}queryOneOauthClientByClientId`, data, baseAxiosRequestConfig);
	}
