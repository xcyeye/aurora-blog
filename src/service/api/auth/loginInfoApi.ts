...
function _baseApi() {
	...
	function queryListDataByCondition(data: Condition) {
		return request.post<PageData<viewBeanType>>(apiPrefix + "queryListLoginInfoByCondition", data, baseAxiosRequestConfig);
	}
	...
	return { queryLoginInfoByUsername, batchDeleteLoginInfoByUid, queryOneData, queryOneDataByUid, queryListDataByCondition, batchUpdateData, updateData, logicDeleteData, physicalDeleteData, insertData, batchInsertData }
}
