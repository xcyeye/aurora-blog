...
function _baseApi() {
	...
	return { queryOneData, queryOneDataByUid, queryListDataByCondition, batchUpdateData, updateData, logicDeleteData, physicalDeleteData, insertData, batchInsertData, bindingEmail, updatePassword, queryUserByUsernameContainPassword }
}
