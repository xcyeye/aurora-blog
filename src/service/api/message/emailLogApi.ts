...
type beanType = EmailLog
type viewBeanType = EmailLogVo
...
function _baseApi() {
	...
	function insertData(data: beanType){
		return request.post<void>(apiPrefix + "insertEmailLog", data, baseAxiosRequestConfig);
	}
	...
	function physicalDeleteData(data: beanType) {
		return request.post<number>(apiPrefix + "physicalDeleteEmailLog", data, baseAxiosRequestConfig);
	}
	...
	function updateData(data: beanType) {
		return request.post<number>(apiPrefix + "updateEmailLog", data, baseAxiosRequestConfig);
	}
	...
	function queryListDataByCondition(data: Condition) {
		return request.post<PageData<viewBeanType>>(apiPrefix + "queryListEmailLogByCondition", data, baseAxiosRequestConfig);
	}
...
export const emailLogApi = _baseApi();
