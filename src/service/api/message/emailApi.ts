...
function _baseApi() {
	...
	return { queryEmailByUserUid, queryByEmailNumber, queryOneData, queryOneDataByUid, queryListDataByCondition, batchUpdateData, updateData, logicDeleteData, physicalDeleteData, insertData, batchInsertData }
}
