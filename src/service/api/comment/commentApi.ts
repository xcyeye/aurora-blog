...
function _baseApi() {
	...
	function queryListDataByCondition(data: Condition) {
		return request.post<PageData<viewBeanType>>(apiPrefix + "queryListCommentByCondition", data, baseAxiosRequestConfig);
	}
	...
	return { queryOneData, queryOneDataByUid, queryListDataByCondition, batchUpdateData, updateData, logicDeleteData, physicalDeleteData, insertData, batchInsertData, queryListCommentByUidArr, resendEmailNotice }
}
