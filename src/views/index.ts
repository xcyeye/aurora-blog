...
export const views: Record<RouterPage.LastDegreeRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  siteSetting: () => import('./siteSetting/index.vue'),
  'siteSetting_site-setting-list': () => import('./siteSetting/site-setting-list/index.vue'),
  'siteSetting_site-setting-modify': () => import('./siteSetting/site-setting-modify/index.vue'),
