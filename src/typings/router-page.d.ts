declare namespace RouterPage {
  ...
  /** 最后一级路由(该级路有对应的vue文件) */
  type LastDegreeRouteKey = Extract<RouteKey, '403' | '404' | '500' | 'article_bulletin' | 'article_category-tag' | 'article_edit' | 'article_friend-link' | 'article_friend-link_friend-link-list' | 'article_friend-link_friend-link-modify' | 'article_manage' | 'article_manage_article-list' | 'article_manage_article-modify' | 'article_share' | 'auth-demo_permission' | 'auth-demo_super' | 'auth-server_login' | 'auth-server_login_login-info-list' | 'auth-server_login_login-info-log' | 'auth-server_oauth' | 'auth-server_oauth_oauth-client-list' | 'auth-server_oauth_oauth-client-modify' | 'component_table' | 'constant-page' | 'dashboard_analysis' | 'dashboard_workbench' | 'exception_403' | 'exception_404' | 'exception_500' | 'file-center_all-file' | 'file-center_all-file_all-file-list' | 'file-center_all-file_all-file-show' | 'file-center_picture' | 'function_tab' | 'function_tab-detail' | 'function_tab-multi-detail' | 'login' | 'message-center_email-log' | 'message-center_email-manage' | 'message-center_email-manage_user-list' | 'message-center_email-manage_user-modify' | 'message-center_mq-message' | 'message-center_send-mail' | 'monitor_nacos' | 'monitor_rabbitmq' | 'monitor_sentinel' | 'multi-menu_first_second' | 'multi-menu_first_second-new_third' | 'not-found' | 'permission_interface' | 'permission_permission-manage' | 'permission_role' | 'plugin_charts_antv' | 'plugin_charts_echarts' | 'plugin_copy' | 'plugin_editor_markdown' | 'plugin_editor_quill' | 'plugin_icon' | 'plugin_map' | 'plugin_print' | 'plugin_swiper' | 'plugin_video' | 'test_test1' | 'test_test2' | 'test_test3' | 'user_manage' | 'user_manage_user-list' | 'user_manage_user-modify' | 'user_profile' | 'user_profile_user-info' | 'user_profile_user-security'>
}
