<template>
  <div class="common"
    ...
    <div class="aurora-common-box">
      <div class="aurora-common-top">
...
export default defineComponent({
  ...
  computed: {
    getIsSidebarScroll() {
      return (isHome) => {
        if (isHome || !this.isSidebarScroll) {
          return ''
        }

        if (this.isSidebarScroll) {
          return 'aurora-common-bottom-right-container-scroll'
        }
      }
    },
    getArticleId() {
