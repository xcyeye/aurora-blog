package xyz.xcye.autoconfigure;
...
public class AuroraProperties {
    ...
    static class AuroraFileProperties {
    ...
    @Data
    static class AuroraPaginationProperties {
    ...
    @Data
    static class AuroraAmqpProperties {
