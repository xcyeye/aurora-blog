...
public interface FileService {
     ...
     */
    ModifyResult insertFile(FileEntityDTO fileEntity, FileDO file, int storageMode) throws CustomFileException;
     ...
     * @throws CustomFileException
     */
    ModifyResult deleteFile(long uid) throws CustomFileException;
