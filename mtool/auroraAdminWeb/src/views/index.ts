...
export const views: Record<RouterPage.LastDegreeRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  'file-center_picture_picture-file-list': () => import('./file-center/picture/picture-file-list/index.vue'),
  'file-center_picture_picture-file-show': () => import('./file-center/picture/picture-file-show/index.vue'),
  ...
  'permission_admin-router_admin-router-list': () => import('./permission/admin-router/admin-router-list/index.vue'),
  'permission_admin-router_admin-router-modify': () => import('./permission/admin-router/admin-router-modify/index.vue'),
  'permission_admin-router': () => import('./permission/admin-router/index.vue'),
  ...
  siteSetting_list: () => import('./siteSetting/list/index.vue'),
