...
const queryDataMethod = (condition: Condition): Promise<RequestResult<PageData<SiteSettingVo>>> => {
	return siteSettingApi.queryListDataByCondition(condition);
}
...
const handleModifyAction = (data: SiteSettingVo) => {
	emitter.emit('siteSettingManageModifySiteSettingAction', data)
}

const handleAddSysSettingAction = () => {
	emitter.emit('siteSettingManageAddSiteSettingAction')
}
