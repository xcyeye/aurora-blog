...
<!--  <div class="">-->
<!--    &lt;!&ndash;一级标题&ndash;&gt;-->
<!--    &lt;!&ndash;<div :date="getCatalogLevel1" :key="itemLevel1Index" :data="getCatalogLevel1" v-for="(itemLevel1,itemLevel1Index) in currentCatalog"&ndash;&gt;-->
<!--    &lt;!&ndash;     id="catalog-single" :class="getCatalogOpenStatus(itemLevel1Index)"&ndash;&gt;-->
<!--    &lt;!&ndash;     class="catalog-single sidebar-catalog-item">&ndash;&gt;-->
<!--    &lt;!&ndash;  &lt;!&ndash;展示一级标题&ndash;&gt;&ndash;&gt;-->
<!--    &lt;!&ndash;  <div class="page-catalog-parent">&ndash;&gt;-->
<!--    &lt;!&ndash;    <div class="catalog-page-title">&ndash;&gt;-->
<!--    &lt;!&ndash;      <router-link :to="itemLevel1.path">&ndash;&gt;-->
<!--    &lt;!&ndash;        <span @click="changeCurrentLevel1Active(event,itemLevel1Index,true)" class="content-single-show">{{getCatalogLevel1Title(itemLevel1)}}</span>&ndash;&gt;-->
<!--    &lt;!&ndash;      </router-link>&ndash;&gt;-->
<!--    &lt;!&ndash;    </div>&ndash;&gt;-->
<!--    &lt;!&ndash;    <div @click="changeCurrentLevel1Active(event,itemLevel1Index,false)" class="catalog-page-spread">&ndash;&gt;-->
<!--    &lt;!&ndash;      <span :class="getSpreadClass(itemLevel1Index)" class="aurora-iconfont-common"></span>&ndash;&gt;-->
<!--    &lt;!&ndash;    </div>&ndash;&gt;-->
<!--    &lt;!&ndash;  </div>&ndash;&gt;-->
<!--		-->
<!--    &lt;!&ndash;  &lt;!&ndash;展示二级标题&ndash;&gt;&ndash;&gt;-->
<!--    &lt;!&ndash;  <div class="page-catalog-children-parent">&ndash;&gt;-->
<!--    &lt;!&ndash;    <div class="page-catalog-children">&ndash;&gt;-->
<!--    &lt;!&ndash;      <div :data="itemLevel2.slug" :key="itemLevel2.slug" v-for="(itemLevel2,itemLevel2Index) in itemLevel1.headers"&ndash;&gt;-->
<!--    &lt;!&ndash;           :class="{catalogChildrenActive: catalogChildrenActive === itemLevel2Index }"&ndash;&gt;-->
<!--    &lt;!&ndash;           class="catalog-page-children-item">&ndash;&gt;-->
<!--    &lt;!&ndash;        <div class="catalog-page-children-title">&ndash;&gt;-->
<!--    &lt;!&ndash;            <span class="catalog-title" @click="clickCatalogTitle($event,itemLevel2.slug,itemLevel1.path,itemLevel1Index)" :slug="itemLevel2.slug">{{itemLevel2.title}}</span>&ndash;&gt;-->
<!--    &lt;!&ndash;        </div>&ndash;&gt;-->
<!--		-->
<!--    &lt;!&ndash;        &lt;!&ndash;展示三级标题&ndash;&gt;&ndash;&gt;-->
<!--    &lt;!&ndash;        <div class="page-catalog-children-level3-parent">&ndash;&gt;-->
<!--    &lt;!&ndash;          <div :style="setLevel3Style(itemLevel2Index)" class="page-catalog-children-level3">&ndash;&gt;-->
<!--    &lt;!&ndash;            <div :key="index" :data="item.slug" v-for="(item,index) in itemLevel2.children"&ndash;&gt;-->
<!--    &lt;!&ndash;                 class="page-catalog-children-level3-title">&ndash;&gt;-->
<!--    &lt;!&ndash;              <span class="catalog-title" @click="clickCatalogTitle($event,item.slug,itemLevel1.path,itemLevel1Index)" :slug="item.slug">{{item.title}}</span>&ndash;&gt;-->
<!--    &lt;!&ndash;            </div>&ndash;&gt;-->
<!--    &lt;!&ndash;          </div>&ndash;&gt;-->
<!--    &lt;!&ndash;        </div>&ndash;&gt;-->
<!--    &lt;!&ndash;      </div>&ndash;&gt;-->
