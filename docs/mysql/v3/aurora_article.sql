/*
 ...
 Date: 15/10/2023 18:00:50
*/
DROP
DATABASE IF EXISTS `aurora_article`;
CREATE
DATABASE `aurora_article` CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci';
use aurora_article;
SET NAMES utf8mb4;
...
-- ----------------------------
INSERT INTO `au_article` VALUES (1713205386126303232, 1, NULL, NULL, NULL, 1, 1713205327737397248, 1, NULL, NULL, '# HI 你好世界', 'HI testuser', NULL, 0, NULL, 0, NULL, NULL, NULL, '2023-10-14 14:49:28', 0);
INSERT INTO `au_article` VALUES (1713363454881439744, 1, NULL, NULL, NULL, 1, 1713363393351000064, 1, NULL, NULL, '# HI 你好世界', 'HI aaaaa', NULL, 0, NULL, 0, NULL, NULL, NULL, '2023-10-15 01:17:35', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1176 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
