...
#faviconIco: https://github.githubassets.com/favicons/favicon.svg
...
logo: https://ooszy.cco.vin/img/blog-public/head.jpg
cancelIcoHref: https://ooszy.cco.vin/img/ico/quxiao.svg
logoTitle: qsyyke
headTitle: 'I do not follow,i lives is always all you want'
...
#需要排除的标签，自动生成的标签中，不会有这个标签
excludeTag: 
  - note

# 已弃用，会自动获取
localhost: http://blog.vipblogs.cn
...
#自定义顶部图片
customTopImg: {
    page: 'https://picoss.cco.vin/animate/wall/555260.png',
    friend: 'https://picoss.cco.vin/animate/wall/669.png',
    tag: 'https://picoss.cco.vin/animate/wall/763311.png',
    mood: 'https://picoss.cco.vin/animate/wall/5849.png'
}
