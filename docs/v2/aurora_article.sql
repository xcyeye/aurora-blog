...
CREATE TABLE `au_talk`  (
  ...
  `picture_uids` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '此说说对应的图片uid集合',
