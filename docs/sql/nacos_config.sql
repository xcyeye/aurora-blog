/*
 ...
 Source Server         : 服务器-自己
 Source Server Type    : MySQL
 Source Server Version : 80026 (8.0.26)
 Source Host           : 81.68.201.154:3306
...
) ENGINE = InnoDB AUTO_INCREMENT = 889 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = 'config_info' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `config_info` VALUES (154, 'store.db.password', 'SEATA_GROUP', 'Cqy19981202', '8fce5c1254e0615fab810a3d55c3a9f1', '2022-04-13 06:40:21', '2022-04-13 06:50:30', 'nacos', '0:0:0:0:0:0:0:1', '', '5a3c7d6c-f497-4d68-a71a-2e5e3340b3ca', NULL, NULL, NULL, 'text', NULL);
...
INSERT INTO `config_info` VALUES (780, 'store.db.password', 'SEATA_GROUP', 'Cqy19981202', '8fce5c1254e0615fab810a3d55c3a9f1', '2022-04-13 13:29:24', '2022-04-13 13:29:24', '', '0:0:0:0:0:0:0:1', '', '', NULL, NULL, NULL, 'text', NULL);
...
INSERT INTO `config_info` VALUES (847, 'share-redis-dev.yaml', 'THEME-GROUP', 'spring:\n  redis:\n    database: 1\n    host: localhost\n    password: \'\'\n    port: 6379\n    jedis:\n      pool:\n        max-active: 15\n        max-idle: 10\n        min-idle: 0\n        max-wait: -1ms', '07c91cba4ee184d924d143f8b8073bc3', '2022-05-19 23:49:25', '2022-05-19 23:49:25', NULL, '0:0:0:0:0:0:0:1', '', 'a6b1905f-d8c6-4a43-8f21-fe662f62bdae', NULL, NULL, NULL, 'yaml', NULL);
INSERT INTO `config_info` VALUES (848, 'share-sentinel-dev.yaml', 'THEME-GROUP', 'spring:\n  cloud:\n    sentinel:\n      transport:\n        port: 8719\n        dashboard: localhost:8080', '3361e1f678b87107616f509ec9b82c68', '2022-05-19 23:50:08', '2022-05-19 23:50:08', NULL, '0:0:0:0:0:0:0:1', '', 'a6b1905f-d8c6-4a43-8f21-fe662f62bdae', NULL, NULL, NULL, 'yaml', NULL);
INSERT INTO `config_info` VALUES (849, 'share-rabbitmq-dev.yaml', 'THEME-GROUP', 'spring:\n  rabbitmq:\n    host: localhost\n    port: 5672\n    username: admin\n    password: 123456\n    publisher-returns: true\n    publisher-confirm-type: correlated\n    listener:\n      direct:\n        acknowledge-mode: manual\n      simple:\n        acknowledge-mode: manual', '61c281a835978b010f801a2dcef192bc', '2022-05-19 23:50:50', '2022-05-19 23:50:50', NULL, '0:0:0:0:0:0:0:1', '', 'a6b1905f-d8c6-4a43-8f21-fe662f62bdae', NULL, NULL, NULL, 'yaml', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1047 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '多租户改造' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of his_config_info
-- ----------------------------
INSERT INTO `his_config_info` VALUES (858, 1045, 'aurora-file-dev.yaml', 'THEME-GROUP', '', 'spring:\n  servlet:\n    multipart:\n      max-file-size: 150MB\n      max-request-size: 500MB\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://127.0.0.1:3306/aurora_file?characterEncoding=utf8&connectTimeout=1000&socketTimeout=3000&autoReconnect=true&useUnicode=true&useSSL=false&serverTimezone=UTC\n    username: root\n    password: Cqy19981202@*\n\n\n# 自定义的配置\naurora:\n  file:\n    nginx-root-path: /Users/aurora/nginx-upload\n    nginx-server-name: http://localhost\n    save-file-folder: aurora-upload\n  snow-flake-worker-id: 12\n  snow-flake-datacenter-id: 23\n  swagger:\n    author:\n      name: aurora\n      url: https://aurora.xcye.xyz\n      email: 2291308094@qq.com\n    api-info:\n      title: 博客文件API\n      description: 这是Aurora主题的博客文件api\n      version: 1.0.0\n      license: MIT\n      license-url: https://github.com/vuepress-aurora/vuepress-theme-aurora/blob/master/LICENSE', '22c802fcd4c8c3d01030c0827c354402', '2022-10-07 17:56:43', '2022-10-07 09:56:43', 'nacos', '106.58.206.106', 'U', 'a6b1905f-d8c6-4a43-8f21-fe662f62bdae');
INSERT INTO `his_config_info` VALUES (858, 1046, 'aurora-file-dev.yaml', 'THEME-GROUP', '', 'spring:\n  servlet:\n    multipart:\n      max-file-size: 150MB\n      max-request-size: 500MB\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://127.0.0.1:3306/aurora_file?characterEncoding=utf8&connectTimeout=1000&socketTimeout=3000&autoReconnect=true&useUnicode=true&useSSL=false&serverTimezone=UTC\n    username: root\n    password: Cqy19981202@*\n\n\n# 自定义的配置\naurora:\n  file:\n    nginx-root-path: /opt/aurora-theme/aurora-nginx-upload\n    nginx-server-name: http://localhost\n    save-file-folder: aurora-upload\n  snow-flake-worker-id: 12\n  snow-flake-datacenter-id: 23\n  swagger:\n    author:\n      name: aurora\n      url: https://aurora.xcye.xyz\n      email: 2291308094@qq.com\n    api-info:\n      title: 博客文件API\n      description: 这是Aurora主题的博客文件api\n      version: 1.0.0\n      license: MIT\n      license-url: https://github.com/vuepress-aurora/vuepress-theme-aurora/blob/master/LICENSE', '4b6ee89086cb77029d41ccb4feda6904', '2022-10-07 18:15:36', '2022-10-07 10:15:36', 'nacos', '106.58.206.106', 'U', 'a6b1905f-d8c6-4a43-8f21-fe662f62bdae');
