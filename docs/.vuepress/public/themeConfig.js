...
module.exports = {
    themeConfig: {
        ...
        * 9.对于评论功能，我其实是想依赖于github的issue，但是Vssue目前只支持vuepress1，所以如果该框架支持
        * vuepress2的时候，我会考虑使用vssue，目前查看用户的评论并不是很方便，还需要登录LeanCloud进行查看，没有直接在
        * github中查看方便，而且信息无价，我并不想将评论存储在其他的服务商处，但是目前使用的评论框架也不会移除，只是
        * 到时候会增加一个选项
        * 10.优化首页文章列表
        *
